...
#include "daksha_msgs/srv/detail/start_record__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = daksha_msgs::srv::StartRecord_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const daksha_msgs::srv::StartRecord_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<daksha_msgs::srv::StartRecord_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StartRecord_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const daksha_msgs::srv::StartRecord_Request *>(
...
static size_t _StartRecord_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StartRecord_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StartRecord_Request__callbacks = {
  "daksha_msgs::srv",
  "StartRecord_Request",
...
static rosidl_message_type_support_t _StartRecord_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartRecord_Request__callbacks,
...
{
  return &daksha_msgs::srv::typesupport_fastrtps_cpp::_StartRecord_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = daksha_msgs::srv::StartRecord_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const daksha_msgs::srv::StartRecord_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<daksha_msgs::srv::StartRecord_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StartRecord_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const daksha_msgs::srv::StartRecord_Response *>(
...
static size_t _StartRecord_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StartRecord_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StartRecord_Response__callbacks = {
  "daksha_msgs::srv",
...
static rosidl_message_type_support_t _StartRecord_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartRecord_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &daksha_msgs::srv::typesupport_fastrtps_cpp::_StartRecord_Response__handle;
}
...
static service_type_support_callbacks_t _StartRecord__callbacks = {
  "daksha_msgs::srv",
  "StartRecord",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, daksha_msgs, srv, StartRecord_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, daksha_msgs, srv, StartRecord_Response)(),
...
static rosidl_service_type_support_t _StartRecord__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartRecord__callbacks,
...
{
  return &daksha_msgs::srv::typesupport_fastrtps_cpp::_StartRecord__handle;
}
