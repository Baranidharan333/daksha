...
static const _StartRecording_Request_type_support_symbol_names_t _StartRecording_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gesture_management, srv, StartRecording_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gesture_management, srv, StartRecording_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gesture_management, srv, StartRecording_Request)() {
  return &::gesture_management::srv::rosidl_typesupport_c::StartRecording_Request_message_type_support_handle;
}
...
static const _StartRecording_Response_type_support_symbol_names_t _StartRecording_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gesture_management, srv, StartRecording_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gesture_management, srv, StartRecording_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gesture_management, srv, StartRecording_Response)() {
  return &::gesture_management::srv::rosidl_typesupport_c::StartRecording_Response_message_type_support_handle;
}
...
static const _StartRecording_type_support_symbol_names_t _StartRecording_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gesture_management, srv, StartRecording)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gesture_management, srv, StartRecording)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gesture_management, srv, StartRecording)() {
  return &::gesture_management::srv::rosidl_typesupport_c::StartRecording_service_type_support_handle;
}
