...
#ifndef COLLISION_MANAGEMENT__SRV__DETAIL__GET_COLLISION_STATUS__FUNCTIONS_H_
#define COLLISION_MANAGEMENT__SRV__DETAIL__GET_COLLISION_STATUS__FUNCTIONS_H_
...
#include "collision_management/msg/rosidl_generator_c__visibility_control.h"

#include "collision_management/srv/detail/get_collision_status__struct.h"

/// Initialize srv/GetCollisionStatus message.
/**
...
/// Create srv/GetCollisionStatus message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * collision_management__srv__GetCollisionStatus_Request__init().
...
/// Destroy srv/GetCollisionStatus message.
/**
 * It calls
 * collision_management__srv__GetCollisionStatus_Request__fini()
...
/// Check for srv/GetCollisionStatus message equality.
/**
...
/// Copy a srv/GetCollisionStatus message.
/**
...
/// Initialize array of srv/GetCollisionStatus messages.
/**
...
/// Finalize array of srv/GetCollisionStatus messages.
/**
 * It calls
 * collision_management__srv__GetCollisionStatus_Request__fini()
...
/// Create array of srv/GetCollisionStatus messages.
/**
 * It allocates the memory for the array and calls
 * collision_management__srv__GetCollisionStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetCollisionStatus messages.
/**
 * It calls
 * collision_management__srv__GetCollisionStatus_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetCollisionStatus message array equality.
/**
...
/// Copy an array of srv/GetCollisionStatus messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * collision_management__srv__GetCollisionStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_collision_management
...
/**
 * It calls
 * collision_management__srv__GetCollisionStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_collision_management
...
/**
 * It allocates the memory for the array and calls
 * collision_management__srv__GetCollisionStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_collision_management
...
/**
 * It calls
 * collision_management__srv__GetCollisionStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COLLISION_MANAGEMENT__SRV__DETAIL__GET_COLLISION_STATUS__FUNCTIONS_H_
