...
setup(
    ...
    data_files=[
        ...
        (os.path.join(share_dir, "launch"), [
            "launch/endpoint.launch.py",
            "launch/vr_control.launch.py",
            "launch/vr_control_mirror.launch.py",
            "launch/vr_control_switch.launch.py",
            "launch/vr_management.launch.py",
        ]),
    ],
