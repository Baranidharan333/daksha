...
HOME_POSITION = np.array([
    ...
    # RIGHT ARM
    # All-zeros here previously commanded right_joint_4 (limit 0.0-2.094395)
    # and right_joint_5 (limit 0-3.14159265) straight to their lower hard
    # mechanical stops on every /move_home call -- 0.0 is each joint's limit,
    # not a neutral pose. Restored the tuned mid-range pose.
    -0.34,
    0.0,
    0.0,
    1.45,
