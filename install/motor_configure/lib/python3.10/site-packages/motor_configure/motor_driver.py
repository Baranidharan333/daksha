...
# Default mapping ranges used for decoding position/velocity/torque out of
# the fixed-point feedback fields. These are read back precisely via the
# debugging assistant (PMAX/VMAX/TMAX registers); these are just the common
# defaults used when no register readout has been done yet.
P_MAX = 12.5
V_MAX = 30.0
T_MAX = 10.0
